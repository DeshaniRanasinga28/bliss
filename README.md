...
The  Bliss Application has used the Flutter Provider package for State management. It is mainly provides a central point to manage the state, and to write front end logic.
